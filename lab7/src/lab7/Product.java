...
public class Product {
	 ...
	 */
		...
		/*
		 * The cast  Product is needed because the paramater 
		 * of otherItem is type Object, which is the superclass of all Java objects.
		 * To access such specific-Product- field 
		 * Must require The Object reference back to a Product reference. 
		 * this allows us to compare fields and product objbects.
		 * 
		 * 
		 * 
		 */
