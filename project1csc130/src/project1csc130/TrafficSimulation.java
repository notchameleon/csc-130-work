...
public class TrafficSimulation {
    ...
    public static void testAll(Vehicle[] road, int direction) {
       //Step1: Create snapshot of original positions
    	
    	Vehicle[] originalRoad = new Vehicle[road.length];
    	
    	for ( int i = 0; i < road.length; i++)
    	{
    		originalRoad[i] = road[i];
    	}
    	...
    	//Proccess movements but check against original positions 
    	if (direction == 1) 
    	{ // FORWARD - process from end to beginning
