...
public class ArrayStack<E> implements StackADT<E>
{
	...
	private void expandCapacity()
	{
		...
		// doubles size
		E[] newContents = (E[]) (new Object[doubleSize]);
		// new array that can hold "twice capacity of old array"
		
		
		// loop that goes through the array contents,everything gets transfered to new array.
